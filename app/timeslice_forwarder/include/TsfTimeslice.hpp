...
public:
  ...
  std::vector<uint8_t*> get_data() { return data_ptr_; }
...
using TimesliceArchive =
    fles::OutputArchive<fles::Timeslice,
                        fles::StorableTimeslice,
                        fles::ArchiveType::TimesliceArchive>;
} // namespace tsforwarder
