...
/// \file
/// \brief Defines the fles::TimesliceDescriptorShmWorkItem serializable struct.
#pragma once
 ...
 */
struct TimesliceDescriptorShmWorkItem {
  ...
  friend std::ostream& operator<<(std::ostream& os,
                                  const TimesliceDescriptorShmWorkItem& i) {
    return os << "TimesliceDescriptorShmWorkItem(shm_uuid=" << i.shm_uuid
