...
class Params:
    ...
    def __init__(self,config_file):
        ...
        self.analyze_data = 0
        self.input_tsclient_customize_str = ""
        self.port = 0
    ...
    def get_tsclient_par(self):
        ...
        self.input_tsclient_customize_str = self.get_value('tsclient_commands', 'input_tsclient_customize_str', 'str', self.input_tsclient_customize_str, False)
