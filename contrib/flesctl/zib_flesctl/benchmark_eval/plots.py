...
class create_plots:
    ...
    def plot_total_data_rate(self):
        ...
        path = os.path.join(dir,'plots/general')
    ...
    def plot_data_rate_single(self):
        dir = os.path.dirname(__file__)
        path = os.path.join(dir,'plots/nodes')
        if not os.path.exists(path):
            os.makedirs(path)
        path = path + '/'
...
def main():
    Logfile_reader_cls_e1 = be.Logfile_reader("../logs/flesnet/entry_nodes/entry_node_htc-cmp505.log", "entry_node")
    Logfile_reader_cls_e2 = be.Logfile_reader("../logs/flesnet/entry_nodes/entry_node_htc-cmp506.log", "entry_node")
    data_rates = {
    ...
    cp_cls = create_plots(data_rates, shm_usages)
